...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "UnrealBridge|UMG")
	static bool RebuildBallSelectDesignerWidget(const FString& WidgetBlueprintPath);

	UFUNCTION(BlueprintCallable, Category = "UnrealBridge|UMG")
	static bool EnsureBallSelectSynthesisDesignerControls(const FString& WidgetBlueprintPath);

	UFUNCTION(BlueprintCallable, Category = "UnrealBridge|UMG")
	static bool RebuildPegInventoryDesignerWidget(const FString& WidgetBlueprintPath);

	UFUNCTION(BlueprintCallable, Category = "UnrealBridge|UMG")
	static bool RebuildShopDesignerWidget(const FString& WidgetBlueprintPath);

	UFUNCTION(BlueprintCallable, Category = "UnrealBridge|UMG")
	static bool EnsureShopForgePillDesignerControls(const FString& WidgetBlueprintPath);

	UFUNCTION(BlueprintCallable, Category = "UnrealBridge|UMG")
	static bool RebuildTooltipPanelDesignerWidget(const FString& WidgetBlueprintPath);

	UFUNCTION(BlueprintCallable, Category = "UnrealBridge|UMG")
	static bool RemoveWidgetFromBlueprint(const FString& WidgetBlueprintPath, const FString& WidgetName);

	UFUNCTION(BlueprintCallable, Category = "UnrealBridge|UMG")
	static bool RebuildVendingDesignerWidget(const FString& WidgetBlueprintPath, const FString& WidgetKind);
};
